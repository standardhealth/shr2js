...
const {Value, QuantifiedValue, CodeValue, RefValue, ChoiceValue, TBD} = require('../models');
  ...
  defToMarkdown(def) {
    ...
    for (const el of def.elements) {
      if (el.value instanceof ChoiceValue) {
        ...
        md += tr(this.valueMD(el), cardinalityMD(el), this.elementDescription(el));
      }
    }
