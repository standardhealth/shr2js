...
function valueToSchemaTypeObject(value) {
  if (value instanceof OrValues) {
    ...
    if (value.isMaxUnbounded() || value.max > 1) {
      ...
      return {'descendingFrom': `http://standardhealthrecord.org/schemas/shr/types.schema.json#/definitions/concept`, '$ref': `http://standardhealthrecord.org/schemas/shr/types.schema.json#/definitions/${value.identifier.name}`};
  }
