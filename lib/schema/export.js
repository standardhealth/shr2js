...
function valueToSchemaTypeObject(value) {
  ...
  if (value.identifier.name == 'code') {
    if (value instanceof CodeFromValueSetValue) {
      ...
      obj.descendingFrom = buildDescendingFrom(value);
    }
    return obj;
...
function buildDescendingFrom(value) {
  return {'code': value.ancestor.code, 'codesystem': value.ancestor.codesystem, 'display': value.ancestor.label};
}
