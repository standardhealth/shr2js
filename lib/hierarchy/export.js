...
//			3{ label: <identifier.name>, type: "Group", isEntry: <isEntry>, concepts: [ *Concept ], description: <description> }
//				4{ *QuantifiedValue }
//          3{ label: <identifier.name>, type: "DataElement", isEntry: <isEntry>, concepts: [ *Concept ], description: <description>, 
//						value: *Value or *Subclass of Value or *QuantifiedValue or *OrValues }

// *Concept				= { label: <label>" ("<codesystem>":"<code>")", type: "Concept", codesystem: <codesystem>, code: <code>, url: <url for concept> }
// *QuantifiedValue		= { type: "QuantifiedValue", min: <min>, max: <max> but if max=* then this attribute left out, value: *Value or OrValues }
// *Value 				= { label: <identifier.namespace>":"<identifier.name>, type: Value, identifier: *Identifier of DataElement or Group }
// *OrValues 			= { type: "OrValues", values: [ *Value or *QuantifiedValue or *OrValues ] }
// *Subclass of Value	= { label: "code from "<valueset>, type: "CodeFromValueSetValue", valueset: <valueset> }
//						  { label: "code descending from "<ancestor.label>" ("<ancestor.codesystem>":"<ancestor.code>")",
//							type: "CodeFromAncestorValue", ancestor: *Concept }
//						  { label: <identifier.namespace>":"<identifier.name>, type: "RefValue", identifier: *Identifier}
// *Identifier			= { label: <name>, type: "Identifier", namespace: <namespace> }

// Example of JSON produced:
//{ 	label: "shr", type: "SHR",
//		children: [
//			{ 	label:"shr.actors", type:"Namespace",
//				children: [ 
...
//								min:1,
//								value: {	label: "HumanName",
//											type: "Value" },
//							{ 	type:"QuantifiedValue", 
//								min:0, 
//								value: { 	label: "ContactInformation",
//								value: { 	label: "ContactInformation",
//											type: "Value" },
//							{	type:"QuantifiedValue", 
//								min:0, 
//								max:1, 
//								value: { 	label: "OrganizationAffiliation",
//											type: "Value" },
//							...
//						]
//					},
...
//		2{ label: <namespace>, type: "Namespace" }
//			3 definitions: *Group or *DataElement
...
//3{ label: <identifier.name>, isEntry: <isEntry>, concepts: [ *Concept ], description: <description> 
...
// *Value 				= { label: <identifier.namespace>":"<identifier.name>, type: Value, identifier: *Identifier of DataElement or Group }
  return {	label: identifierToString(value.identifier),
			type: "Value",
...
// *Subclass of Value	= { label: <valueset>, type: "CodeFromValueSetValue" }
//						  { type: "CodeFromAncestorValue", ancestor: *Concept }
//						  { label: <identifier.namespace>":"<identifier.name>, type: "RefValue", identifier: *Identifier}
function codeFromValueSetValueToHierarchyJSON(value) {
	return {	label: `code from ${value.valueset}`,
				type: "CodeFromValueSetValue",
				valueset: value.valueset };
}

function codeFromAncestorValueToHierarchyJSON(value) {
	return {	label: `code descending from ${conceptToString(value.ancestor)}`,
...
// *Concept				= { label: <label> else <codesystem>":"<code>, type: "Concept", codesystem: <codesystem>, code: <code>, url: <url for concept> }
  const result = {};
