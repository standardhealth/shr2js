...
class ValuesetConceptRule extends Concept {
    constructor(system, code, display) {
        super(system, code, display);
        this._descendingFrom = null;
        this._includesFrom = null;
    }
    get descendingFrom() { return this._descendingFrom; }
    set descendingFrom(descendingFrom) {
        this._descendingFrom = descendingFrom;
    }
    get includesFrom() { return this._includesFrom; }
    set includesFrom(includesFrom) {
        this._includesFrom = includesFrom;
    }
}
...
module.exports = {Namespace, DataElement, Concept, Identifier, PrimitiveIdentifier, Value, Valueset, ValuesetConceptRule, IdentifiableValue, RefValue, ChoiceValue, IncompleteValue, TBD, ConstraintsFilter, Cardinality, ValueSetConstraint, CodeConstraint, TypeConstraint, CardConstraint, PRIMITIVE_NS, PRIMITIVES};